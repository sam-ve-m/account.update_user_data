#!/bin/bash
fission spec init
fission env create --spec --name acc-data-update-env --image nexus.sigame.com.br/fission-account-update-user-data:0.1.2 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
